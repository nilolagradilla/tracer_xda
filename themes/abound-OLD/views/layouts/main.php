...
<html lang="en">
  <head>
    ...
    //$cs->registerScriptFile(Yii::app()->baseUrl.'/js/all.js', CClientScript::POS_END);

	?>
    <!-- Fav and Touch and touch icons -->
    <link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl;?>/images/logoDOST.png">
	...
	<?php  
      ...
      <!-- styles for style switcher -->
        ...
        <link rel=" stylesheet" type="text/css" media="screen" title="style7" href="<?php echo $baseUrl;?>/css/style-red.css" />
	  <?php
